...
<svg class={twMerge("nav-icon overflow-visible")} width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
...
<img src={RedHeart} class={twMerge(`opacity-0 absolute top-0 left-0`, likeIsAnimating ? "heart-animation" : "")} alt="Herz"/>
