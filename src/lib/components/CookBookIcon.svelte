...
>
	<path
		class={twMerge("transition-[stroke] duration-150 group-hover:stroke-yellow", likeIsAnimating && "animate-hat")}
...
<img src={RedHeart} class={twMerge(`absolute left-0 top-0 opacity-0`, likeIsAnimating && "animate-heart")} alt="Herz" />
